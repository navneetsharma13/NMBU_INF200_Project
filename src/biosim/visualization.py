...
class Visualization:
    ...
    def draw_layout(self):
        ...
        self.ax_hm_herb = fig.add_subplot(gs[2:5, 0:2])
        self.ax_hm_carn = fig.add_subplot(gs[2:5, 2:4])
        self.ax_fitness = fig.add_subplot(gs[5:, 0:2])
        self.ax_age = fig.add_subplot(gs[5:, 2:4])
        self.ax_weight = fig.add_subplot(gs[5:, 4:])
    ...
    def draw_heatmap(self):
        ...
        self.carn_hm_axis = self.ax_hm_carn.imshow(self.pop_matrix_carn, interpolation='nearest',
                                                   cmap='plasma')
        plt.colorbar(self.carn_hm_axis, ax=self.ax_hm_carn, orientation='vertical')
