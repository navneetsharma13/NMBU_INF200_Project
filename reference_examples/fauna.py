...
class Fauna():
    ...
    """
    parameters={}
    def __init__(self, weight: object = None, age: object = None) -> object:
    ...
    def default_weight(cls):
        mu=math.log(cls.parameters['w_birth']**2/math.sqrt(cls.parameters['w_birth']**2+cls.parameters['sigma_birth']))
        sigma=math.log(1+cls.parameters['sigma_birth']**2/cls.parameters['w_birth']**2)
        return random.lognormvariate(mu,sigma)
        #return np.random.lognormal(cls.parameters['w_birth'],cls.parameters['sigma_birth'])
    ...
    def prob_birth(self,animal_number):
    ...
    def losing_weight_on_birth(self,child):
